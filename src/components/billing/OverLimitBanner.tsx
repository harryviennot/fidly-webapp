  ...
  return (
    <div
      className={cn(
        ...
        "bg-[var(--warning-light)] border-b border-[var(--warning)]/20 text-[var(--foreground)]",
        "text-sm"
      )}
    >
      <WarningIcon className="w-4 h-4 shrink-0 text-[var(--warning)]" weight="fill" />
      ...
      <div className="flex items-center gap-2 shrink-0">
        <Link
          href="/billing"
          className="inline-flex items-center gap-1 text-xs font-semibold text-[var(--warning)] hover:opacity-80 transition-opacity"
        >
          {t("bannerUpgrade")}
        ...
        <button
          ...
          className="p-1 rounded hover:bg-[var(--warning)]/10 transition-colors text-[var(--muted-foreground)] hover:text-[var(--foreground)]"
          aria-label="Dismiss"
        >
